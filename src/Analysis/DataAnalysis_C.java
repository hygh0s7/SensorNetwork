...
import static Globals.Analyzable.FILEAA;
import static Globals.Fusionable.FILEA;
import static Globals.Fusionable.FILEC;
 ...
 * @author Admin
 */
public class DataAnalysis_C extends DataAnalysis {

    public DataAnalysis_C(String NodeID, Location location) {
    ...
    public void writeDataToFile() {
        try {
            ...
            BufferedWriter bw;
            bw = new BufferedWriter(new FileWriter(FILEAC));
