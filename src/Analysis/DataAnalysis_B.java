...
import static Globals.Fusionable.FILEB;
 ...
 * @author Admin
 */
public class DataAnalysis_B extends DataAnalysis {

    public DataAnalysis_B(String NodeID, Location location) {
    ...
    public void writeDataToFile() {
        try {
            ...
            BufferedWriter bw;
            bw = new BufferedWriter(new FileWriter(FILEAB));
